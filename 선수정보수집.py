...
for year in list_year:
    ...
    for info in information:
        ...
        data.columns = ['연도', '날짜', '타수', '득점', '안타', '2타', '3타', '홈런', '루타', '타점',
                                    '도류', '볼넷', '사구', '고4', '삼진', '병살', '희타', '희비', '타율', '출루'
                        , '장타', 'OPS', '투구', 'avLI', 'RE24', 'WPA']
        data.head()
        data.to_csv('./dataSet/'+year+'선수정보수집/' + name + '선수정보.csv', encoding='UTF-8')